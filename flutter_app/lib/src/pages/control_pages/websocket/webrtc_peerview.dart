...
class WebRTCPeerView extends StatefulWidget {
  const WebRTCPeerView({Key? key, this.controller}) : super(key: key);

  final WebRTCController? controller;

  @override
  State<WebRTCPeerView> createState() => _WebRTCPeerViewState();
}

class _WebRTCPeerViewState extends State<WebRTCPeerView> {
        ...
        child: Scaffold(
          body: GestureDetector(
            ...
            child: Stack(
              children: [
                _videoWidget(
                  _controller.localVideoNotifier,
